...
import { faLinkedinIn, faGithub, faTwitter, faFacebook, faHtml5, faCss3, faSquareJs, faAngular, faReact, faNodeJs, faSass, faLess, faWordpress, faGulp, faGrunt, faNpm, faNode } from '@fortawesome/free-brands-svg-icons'
function App() {
