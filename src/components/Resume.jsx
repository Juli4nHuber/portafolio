        ...
        <div className="container-fluid p-0">
            <section className="resume-section" id="about" >
                <div className="resume-section-content">
                    <h1 className="t1"> Clarence <span className="text-primary">Taylor</span></h1>
                    <div className="subheading mb-5">
                        3542 Berry Street · Cheyenne Wells, CO 80810 · (317) 585-8468 ·
                        <a className="link-primary" href="mailto:name@email.com">name@email.com</a>
                    </div>
                    <p className="lead mb-5">I am experienced in leveraging agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition.</p>
                    <div className="social-icons">
                        <a className="social-icon" href="#!"><FontAwesomeIcon icon={faLinkedinIn} /></a>
            ...
            <section className="resume-section" id="experience">
                <div className="resume-section-content">
                    <h2 className="t2 mb-5">Experience</h2>
                    <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="flex-grow-1">
                            <h3 className="t3 mb-0">Senior Web Developer</h3>
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="flex-grow-1">
                            <h3 className="t3 b-0">Web Developer</h3>
                            <div className="subheading mb-3">Intelitec Solutions</div>
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="flex-grow-1">
                            <h3 className="t3 mb-0">Junior Web Designer</h3>
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-between">
                        <div className="flex-grow-1">
                            <h3 className="t3 mb-0">Web Design Intern</h3>
                            <div className="subheading mb-3">Shout! Media Productions</div>
            ...
            <section className="resume-section" id="education">
                <div className="resume-section-content">
                    <h2 className="t2 mb-5">Education</h2>
                    <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="flex-grow-1">
                            <h3 className="t3 mb-0">University of Colorado Boulder</h3>
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-between">
                        <div className="flex-grow-1">
                            <h3 className="t3 mb-0">James Buchanan High School</h3>
            ...
            <section className="resume-section" id="skills">
                <div className="resume-section-content">
                    <h2 className="t2 mb-5">Skills</h2>
                    ...
                    <ul className="list-inline dev-icons">
                        ...
                        <li className="list-inline-item"><FontAwesomeIcon icon={faSquareJs} /></li>
                        ...
                        <li className="list-inline-item"><FontAwesomeIcon icon={faGrunt} /></li>
            ...
            <section className="resume-section" id="interests">
                <div className="resume-section-content">
                    <h2 className="t2 mb-5">Interests</h2>
            ...
            <section className="resume-section" id="awards">
                <div className="resume-section-content">
                    <h2 className="t2 mb-5">Awards & Certifications</h2>
                    <ul className="fa-ul mb-0">
                        <li>
